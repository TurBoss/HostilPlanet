...
class tdraw(gui.Widget):
    def __init__(self, w, h):
        ...
        for x in range(0, app.tile_w):
            pygame.draw.line(s, (0, 0, 0), (self.rect.w * x / app.tile_w, 0),
                             (self.rect.w * x / app.tile_w, self.rect.h))
        for y in range(0, app.tile_h):
            pygame.draw.line(s, (0, 0, 0), (0, self.rect.h * y / app.tile_h),
    ...
    def paint(self, s):
        ...
        r = app.select
        pygame.draw.rect(s, (255, 255, 255, 128), Rect(r.x * self.rect.w / app.tile_w, r.y * self.rect.h / app.tile_h,
                                                       r.w * self.rect.w / app.tile_w, r.h * self.rect.h / app.tile_h),
                         4)
